...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-noise">
      <Seo title={'Prizelet — Private Betting Infrastructure for Creators'} description={'Prizelet is the invite-only system where proven sports creators sell picks, run subscriptions, and grow a private network of members.'} />
      <Navbar />
