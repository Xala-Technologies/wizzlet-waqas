...
const Pricing = () => (
  <div className="min-h-screen bg-background">
    <Seo title={'Pricing — Prizelet for Creators'} description={'Transparent Prizelet pricing: a 5% intro platform fee for your first 30 days, then 10%. No setup fees, no monthly minimum.'} />
      <Navbar />
