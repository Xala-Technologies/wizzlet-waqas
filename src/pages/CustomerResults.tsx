    ...
    <>
      <div className={compact ? 'w-full sm:w-[75px]' : ''}>
        ...
        <Input
          ...
          min="1.01"
          placeholder="1.91"
          className={compact ? 'h-8 text-base md:text-sm' : ''}
          value={form.eu_odds}
        ...
        <div className="rounded-lg border border-primary/20 bg-card p-3 mb-4">
          <div className="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-4 xl:flex xl:flex-wrap xl:items-end">
            <div className="w-full sm:w-auto xl:w-[100px]">
              ...
              <Input type="date" className="h-9 text-base md:text-sm" value={form.date} onChange={e => setForm(f => ({ ...f, date: e.target.value }))} />
            </div>
            <div className="w-full sm:col-span-2 xl:flex-1 xl:min-w-[120px]">
              ...
              <Input className="h-9 text-base md:text-sm" placeholder="Chiefs -3.5" value={form.pick_event} onChange={e => setForm(f => ({ ...f, pick_event: e.target.value }))} />
            </div>
            ...
            <div className="w-full sm:w-auto xl:w-[72px]">
              ...
              <Input type="number" step="0.5" className="h-9 text-base md:text-sm" value={form.units_risked} onChange={e => setForm(f => ({ ...f, units_risked: e.target.value }))} />
            </div>
            ...
            <div className="w-full sm:w-auto xl:w-[72px]">
              ...
              <Input type="number" step="0.5" className="h-9 text-base md:text-sm" value={form.units_won_lost} onChange={e => setForm(f => ({ ...f, units_won_lost: e.target.value }))} />
            </div>
