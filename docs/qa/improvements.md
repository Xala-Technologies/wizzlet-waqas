...
| Paginate admin `.collect()` (F-012) | Scale safety | Admin lists use cursors | M | W19–W21: list UIs + exact scans for dashboard/finance/fees/alerts; residual Reports + payout joins |
